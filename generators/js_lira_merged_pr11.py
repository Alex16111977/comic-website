    ...
    def generate(character_data):
        ...
        for phase in character_data.get('journey_phases', []):
            ...
            phase_vocabularies[phase_id] = {
                ...
                'words': words,
                'quizzes': quizzes,  # From main branch
            }
        ...
        # Add enhanced mobile-friendly interaction code with BOTH features
        vocab_js += '''
...
// Relations variables from PR #11
...
// === QUIZ FUNCTIONS FROM MAIN BRANCH ===
...
// === RELATIONS FUNCTIONS FROM PR #11 ===
...
// === MAIN DISPLAY FUNCTION WITH BOTH FEATURES ===
function displayVocabulary(phaseKey) {
    ...
    // Update quizzes (FROM MAIN BRANCH)
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Initialize relations elements (FROM PR #11)
    ...
    // Initialize relations toggle handlers (FROM PR #11)
    relationToggles.forEach(toggle => {
    ...
    attachQuizHandlers(); // FROM MAIN BRANCH
